-- Create table for employee dataset, "employee.csv", to upload data from Kaggle to pgAdmin.
...
-- After importing employee dataset to the table, let's see what kind of data we're working with. 
...
-- It seems there are a few duplicates, for testing purposes I'm only interested in unique values. Let's create a unique values table.  
...
-- Looks good, let's do some exploratory data analysis (EDA).  
